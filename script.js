...
class App {
    ...
    _newWorkout(e) {
        ...
        if (type === 'running') {
            ...
            if (!validInputs(distance, duration, cadence) || !allPositive(distance, duration, cadence)) return alert('Błąd');
        ...
        if (type === 'cycling') {
            ...
            if (!validInputs(distance, duration, elevation) || !allPositive(distance, duration)) return alert('Błąd')
